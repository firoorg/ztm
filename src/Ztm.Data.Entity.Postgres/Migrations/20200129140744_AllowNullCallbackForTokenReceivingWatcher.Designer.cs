...
namespace Ztm.Data.Entity.Postgres.Migrations
{
    ...
    [Migration("20200129140744_AllowNullCallbackForTokenReceivingWatcher")]
    partial class AllowNullCallbackForTokenReceivingWatcher
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ztm.Data.Entity.Contexts.Main.TokenReceivingWatcherRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid>("AddressReservationId");
                    ...
                    b.HasIndex("AddressReservationId")
                        .IsUnique();
                    ...
                    b.ToTable("TokenReceivingWatcherRules");
                });

            modelBuilder.Entity("Ztm.Data.Entity.Contexts.Main.TokenReceivingWatcherWatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TokenReceivingWatcherWatches");
                });
            ...
            modelBuilder.Entity("Ztm.Data.Entity.Contexts.Main.TokenReceivingWatcherRule", b =>
                {
                    b.HasOne("Ztm.Data.Entity.Contexts.Main.ReceivingAddressReservation", "AddressReservation")
                        .WithOne()
                        .HasForeignKey("Ztm.Data.Entity.Contexts.Main.TokenReceivingWatcherRule", "AddressReservationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Ztm.Data.Entity.Contexts.Main.WebApiCallback", "Callback")
                        .WithOne()
                        .HasForeignKey("Ztm.Data.Entity.Contexts.Main.TokenReceivingWatcherRule", "CallbackId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Ztm.Data.Entity.Contexts.Main.TokenReceivingWatcherWatch", b =>
                {
                    ...
                    b.HasOne("Ztm.Data.Entity.Contexts.Main.TokenReceivingWatcherRule", "Rule")
                        .WithMany("Watches")
